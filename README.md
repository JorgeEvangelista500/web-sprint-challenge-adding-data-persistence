...
1. Explain the difference between Relational Databases and SQL.
   Relational data based store information on a table like format consisting of columns and rows, SQL is a language you can use to interact with databases.

2. Why do tables need a Primary Key?
   Primary keys are necessary is a way to identify each entry on a particular table uniquely.

3. What is the name given to a table column that references the Primary Key on another table?
   The given is a foreign key.

4. What do we need in order to have a _many to many_ relationship between two tables?
   in order to have a many to many relationship between two tables you need a third table or intermediary table that has foreign keys from each table.
